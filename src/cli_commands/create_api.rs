...
impl BuildApi for SpringBootApi {
    fn execute(&self) -> Result<bool, DomainErrors> {
...
impl SpringBootApi {
    pub fn build(
        ...
        packaging: String,
        java: u16,
    ) -> Result<SpringBootApi, DomainErrors> {
        Ok(SpringBootApi {
            name,
            project_type,
            language,
...
pub fn create_spring_boot_config(name: &str) -> Result<SpringBootApi, DomainErrors> {
